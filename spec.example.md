...
| Field | Meaning |
|:--|:--|
| **ID** | Unique identifier, stable for the spec's life. Joins to the pipeline ledger. |
...
No status field. (If a spec carries one, TRON ignores it — the ledger is authoritative.)
